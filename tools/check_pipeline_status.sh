...
check_file "outputs/fir_tags_grand_autotuned/reports/ai_stage_contribution_summary.csv"
check_file "outputs/fir_tags_grand_autotuned/reports/ai_stage_visit_summary.csv"
